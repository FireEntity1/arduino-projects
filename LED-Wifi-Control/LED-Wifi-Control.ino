...
const char* ssid = "SSID";                 // Declare your Wi-Fi name here within the double quotes
const char* password = "PASSWORD";             // Declare your Wi-Fi password here within the double quotes
...
{ 
  ...
  int val1;
  int val2;
  if (req.indexOf("/on") != -1)           // Match the request
    val1 = 1;
